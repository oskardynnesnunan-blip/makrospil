...
export type GameCase = {
  ...
  hints: string[];
  optionA: GameCaseOption;
  optionB: GameCaseOption;
};

export const gameCases: Record<string, GameCase> = {
  intro_inflation: {
    id: "intro_inflation",
    title: "Inflationen bider sig fast",
    description:
  ...
  debt_doubt: {
    id: "debt_doubt",
    title: "Markedet tvivler på gælden",
    description:
  ...
  market_panic: {
    id: "market_panic",
    title: "Markederne mister tillid",
    description:
  ...
  bond_selloff: {
    id: "bond_selloff",
    title: "Obligationsmarkedet sælger ud",
    description:
  ...
  energy_shock: {
    id: "energy_shock",
    title: "Energichok rammer økonomien",
    description:
  ...
  trade_break: {
    id: "trade_break",
    title: "Handelsbrud og forsyningsproblemer",
    description:
  ...
  climate_damage: {
    id: "climate_damage",
    title: "Klimachok forstyrrer økonomien",
    description:
  ...
  currency_slide: {
    id: "currency_slide",
    title: "Valutaen kommer under pres",
    description:
  ...
  global_crisis: {
    id: "global_crisis",
    title: "Global krise på flere fronter",
    description:
  ...
  public_strike_wave: {
    ...
    hints: [
      ...
      "Overvej forskellen på ro nu og pres senere.",
    ],
    optionA: {
      id: "costly_deal_now",
